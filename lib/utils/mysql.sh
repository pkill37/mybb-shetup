mysql_location() {
    if command_exists mysql; then
        ...
        input_reply "Where is the MySQL executable located? Full path required." mysql_executable
    fi
}
...
mysql_run_commands() {
    ...
    input_reply "What should the username be for the regular DB user that MyBB will use?" "mybb" db_user
    input_reply "Great! What should its password be? []: " db_pass
